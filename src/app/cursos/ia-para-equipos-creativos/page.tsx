        ...
        <section className="bg-black text-white p-8 sm:p-12 border-2 border-black shadow-neo text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a 
              href="#chat"
              data-open-chat="true"
              data-chat-prompt="Hola Rubén, me interesa solicitar una propuesta corporativa in-company para el programa 'IA para Equipos Creativos'."
            ...
            >
              <Sparkles size={20} /> SOLICITAR PROPUESTA EN EL CHAT
            </a>
          </div>

          <div className="font-mono text-xs text-zinc-400 pt-4 border-t border-zinc-800">
            Atención corporativa directa por nuestro <span className="text-brand-yellow font-bold">Chatbot Asistente</span> (esquina inferior derecha)
          </div>
        </section>
